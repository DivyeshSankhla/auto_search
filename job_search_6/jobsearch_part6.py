#!/usr/bin/env python3
"""
Part 6 job-search automation.

This script implements the repeatable /jobsearch flow for job_search_6 only:
...
OFFICIAL_DOMAINS = {
    "Torc Robotics": ("boards-api.greenhouse.io", "job-boards.greenhouse.io", "boards.greenhouse.io", "torc.ai"),
    "Applied Intuition": ("api.ashbyhq.com", "jobs.ashbyhq.com", "appliedintuition.com"),
    "Aurora": ("boards-api.greenhouse.io", "job-boards.greenhouse.io", "boards.greenhouse.io", "aurora.tech"),
    "Skydio": ("api.ashbyhq.com", "jobs.ashbyhq.com", "skydio.com"),
    "Boston Dynamics": ("bostondynamics.wd1.myworkdayjobs.com", "bostondynamics.com"),
    "Symbotic": ("symbotic.wd504.myworkdayjobs.com", "symbotic.com"),
    "Zipline": ("boards-api.greenhouse.io", "job-boards.greenhouse.io", "boards.greenhouse.io", "zipline.com"),
    "Figure AI": ("boards-api.greenhouse.io", "job-boards.greenhouse.io", "boards.greenhouse.io", "figure.ai"),
    "Agility Robotics": ("boards-api.greenhouse.io", "job-boards.greenhouse.io", "boards.greenhouse.io", "agilityrobotics.com"),
    "Waabi": ("jobs.lever.co", "api.lever.co", "waabi.ai"),
}
...
def build_adapters() -> List[BaseAdapter]:
    return [
        GreenhouseAdapter("Torc Robotics", "torcrobotics"),
        AshbyAdapter("Applied Intuition", "applied"),
        GreenhouseAdapter("Aurora", "aurorainnovation"),
        AshbyAdapter("Skydio", "skydio"),
        WorkdayCXSAdapter(
            "Boston Dynamics",
        ...
        WorkdayCXSAdapter(
            ...
            "https://symbotic.wd504.myworkdayjobs.com/Symbotic",
        ),
        GreenhouseAdapter(
            "Zipline",
            "flyzipline",
            public_url_template="https://www.zipline.com/careers?gh_jid={id}#open-roles",
        ),
        GreenhouseAdapter("Figure AI", "figureai"),
        GreenhouseAdapter(
            "Agility Robotics",
            "agilityrobotics",
            public_url_template="https://www.agilityrobotics.com/about/job-post?gh_jid={id}",
        ),
        LeverAdapter("Waabi", "waabi"),
    ]
...
def run_search(args: argparse.Namespace) -> int:
    ...
    print(f"Part 6 search: limit={ctx.limit}, days={ctx.days}, cutoff={ctx.cutoff.isoformat()}")
...
def run_self_tests() -> int:
    ...
    loc_raw = RawJob("Boston Dynamics", "requests", "t", "https://x", location="US, Massachusetts, Waltham")
    check("location us state city", location_ok(loc_raw))

    check("official url skydio", is_official_url("Skydio", "https://jobs.ashbyhq.com/skydio/abc"))
    ...
    good = RawJob(
        ...
        url="https://bostondynamics.wd1.myworkdayjobs.com/Boston_Dynamics/job/Waltham/Embedded-Firmware_R123",
        job_id="R123",
    ...
    existing = {"https://bostondynamics.wd1.myworkdayjobs.com/Boston_Dynamics/job/Waltham/Embedded-Firmware_R123"}
    dup = dataclasses.replace(good, url="https://bostondynamics.wd1.myworkdayjobs.com/Boston_Dynamics/job/Waltham/Embedded-Firmware_R123")
...
def parse_args(argv: Optional[Sequence[str]] = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run Part 6 official-source job search.")
